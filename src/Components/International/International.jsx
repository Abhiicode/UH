        ...
        <>
            <div className="international_body">
                ...
                <div className="international_container">
                    ...
                    <InternationalCard img_src="./images/maldives_1.jpg" title="Maldives Tour Packages" desc="The Maldives is irresistible with its white beaches, turquoise sea, blue lagoons, colourful marine life and many palm trees. With a temperature of around 30C all days of the year, the Maldives is a dream come true at any time." />
                </div>
            </div>
        </>
    )
